...
if(strcmp($row["password"],$pass)==0)
{
    ...
    {
	     echo '{"status":200,"url":"../HTML/donoractivitypage.html","role":"donor"}';
    }
    else if(strcmp("volunteer",$roll)==0)
    {
	   echo '{"status":200,"url":"../HTML/volactivitypage.html","role":"volunteer"}';
    }
    else
    {
         echo '{"status":200,"url":"../HTML/recactivitypage.html","role":"recipient"}';   
    }
    exit();
}
else
